...
<head>
    ...
    <title>Overview QA Manager</title>
</head>

<body>
    <div class="departmentItem">
        <div class="departmentName-container">
            <header class="header" name="departmentName">Department name</header>

            <div class="content">
                <div class="row1">
                    <div class="totalFeedback">
                        <p class="row1-col1-title">Total Feedback</p>
                        <p class="row1-col1-value" name="totalFeedback">9999</p>
                    </div>

                    <div class="percentFeedback">
                        <p class="row1-col2-title">Percentage of Feedback</p>
                        <p class="row1-col2-value" name="percentFeedback">99%</p>
                    </div>

                    <div class="totalContributor">
                        <p class="row1-col3-title">Total Feedback</p>
                        <p class="row1-col3-value" name="totalContributor">9999</p>
                    </div>
                </div>
