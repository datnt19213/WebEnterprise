...
<body>
    <div class="qa-ad-fb-mn-container">
        <div class="title-contact-btn">
            <p class="ad-qa-mn-title">Staff Management</p>
        </div>
        ...
        <div class="qa-ad-scroll-table">
            <div class="qa-ad-table-data">
                ...
                $result = mysqli_query($conn, "SELECT * FROM user_tb a, position_tb b, department_tb c WHERE b.position_id = a.position_id AND c.department_id = a.department_id AND c.state_code=0");
